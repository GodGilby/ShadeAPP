...
public class DetectSwipeSeguridad extends GestureDetector.SimpleOnGestureListener {
    ...
    private RelajacionAsustadaActivity activity = null;

    public RelajacionAsustadaActivity getActivity() {
        return activity;
    }

    public void setActivity(RelajacionAsustadaActivity activity) {
