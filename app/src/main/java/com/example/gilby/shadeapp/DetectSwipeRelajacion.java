...
public class DetectSwipeRelajacion extends GestureDetector.SimpleOnGestureListener {
    ...
    private RelajacionActivity activity = null;

    public RelajacionActivity getActivity() {
        return activity;
    }

    public void setActivity(RelajacionActivity activity) {
